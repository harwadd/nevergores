...
MACRO_CONFIG_STR(SvWhitelistMessage, sv_whitelist_message, 255, "", CFGFLAG_SERVER, "Display whitelist message")

// welcome broadcast
MACRO_CONFIG_INT(SvWelcomeBroadcast, sv_welcome_broadcast, 1, 0, 1, CFGFLAG_GAME | CFGFLAG_SERVER, "Display welcome message")
...
MACRO_CONFIG_INT(SvEffectCarryDuration, sv_effect_carry_duration, 999, 0, 999, CFGFLAG_GAME | CFGFLAG_SERVER, "Duration for carry effect (seconds)")

MACRO_CONFIG_INT(SvEffectCarryWithRace, sv_effect_carry_with_race, 1, 0, 1, CFGFLAG_GAME | CFGFLAG_SERVER, "Enable carry power even with race started (considered cheat)")

MACRO_CONFIG_INT(SvNeedsLogin, sv_needs_login, 0, 0, 1, CFGFLAG_GAME | CFGFLAG_SERVER, "Turn on or off login")
...
//MACRO_CONFIG_STR(RainbowTee, rainbow, 0, 0, 1, CFGFLAG_GAME | CFGFLAG_SERVER, "Enable Rainbow Tee")

MACRO_CONFIG_INT(SvChatProtection, sv_chat_protection, 1, 0, 1, CFGFLAG_SERVER, "Apply chat filters")