#ifndef GENERATED_PROTOCOLGLUE_H
#define GENERATED_PROTOCOLGLUE_H
extern const int gs_Msg_SixToSeven[54];
inline int Msg_SixToSeven(int a) { if(a < 0 || a >= 54) return -1; return gs_Msg_SixToSeven[a]; }
...
#endif //GENERATED_PROTOCOLGLUE_H
